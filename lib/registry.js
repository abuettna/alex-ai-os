...
export const REGISTRY_VERSION = "2025-08-16";
 ...
 * @property {string[]} knownIntegrations
 * @property {string} [costNotes]
 * @property {string} setupComplexity
 * @property {string[]} strengths
 * @property {string[]} limitations
 * @property {string} founderExperience
